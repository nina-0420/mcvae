# -*- coding: utf-8 -*-
"""
Created on Wed Apr 21 20:02:19 2021
...
def dcm2nii_2(path, pat, mod, center):
    ...
    if np.shape(np.shape(image))[0] == 2:
        ...
        filename = 'C:/Users/scnc/Downloads/code/tagging_cine_exp/data_tc/tagging/10xxxxx/1001629/' + center + '{}_{}.nii.gz'.format(pat, mod)
