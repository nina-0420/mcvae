    ...
    def __init__(self,
        ...
        for idx, ID in enumerate(ids_set.values):
            ...
            if len(img_21015) >= 1:
                ...
                self.mtdt.append([ID[4],   ID[11]])
                #self.mtdt.append([mtdt_scaled['sex'][idx], mtdt_scaled['dbpa'][idx], mtdt_scaled['sbpa'][idx], mtdt_scaled['ss'][idx], mtdt_scaled['ads'][idx], mtdt_scaled['bmi'][idx], mtdt_scaled['age'][idx], mtdt_scaled['hba1c'][idx],mtdt_scaled['chol'][idx], mtdt_scaled['glucose'][idx]])
