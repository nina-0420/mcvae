...
if __name__ == "__main__":
    ...
    parser.add_argument('--dir_ids', type=str, default='./input_data/ids/manual_LVM_LVEDV_mtdt2.csv')
    ...
    parser.add_argument('--dir_test_ids', type=str, default='2020-05-17_11-36-05_manual_2000Epochs_reducedList/')
    ...
    if not args.test_mode:
        ...
        copyfile('main_mcVAE_r.py', args.dir_results +  'main_mcVAE_r.py')
